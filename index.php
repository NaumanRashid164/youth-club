...
<div class="container">
    <div class="summer_project">
        ...
        <section class="key_priciples mt-5 ">
        ...
        <div class="application_form_title">
        ...
        <form>
             <div id="accordion">
            <section class="contact_detail section mb-20">
                <h1>Contact Details</h1>
                <div id="contact" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                    <table class="table table-bordered" style="border-color: #212529">
                        <tbody>
                        <tr>
                            <td width="40%" class="bg-gray text-bold">1. Name of Club/Group</td>
                            <td><input type="text" class="form-control" id="club_name" name="club_name"
                                       value="ABC Youth Club"></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td width="40%" class="bg-gray text-align-right">Correspondence Address(Including Eircode)
                                <br> (All posted correspondence will go to this address)
                            </td>
                        ...
                        <tr>
                            ...
                            <td><input type="email" class="form-control" id="secretary_email" name="secretary_email" required>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td width="40%" class="bg-gray text-align-right">Club/Group Generic Email: <br> (not the
                        ...
                        <tr>
                            <td width="40%" class="bg-gray text-align-right">Co-ordinator's Contact Email</td>
                            <td><input type="email" class="form-control" id="coordinator_email"
                                       name="coordinator_email">
                            </td>
                        </tr>
                        <tr>
                            <td width="40%" class="bg-gray text-align-right">Co-ordinator's Contact Telephone Number
                            </td>
                    ...
                    <button class="move-next btn btn-success" type="button" data-toggle="collapse" data-target="#banking" aria-expanded="true" aria-controls="banking">Next</button>
                </div>
                </div>
                
            </section>
            <section class="banking_detail section mb-20">
                <h1>Banking Details</h1>
                <div id="banking" class="collapse" aria-labelledby="headingOne" data-parent="#accordion">
                    <table class="table table-bordered" style="border-color: #212529">
                        <tbody>
                        <tr>
                        ...
                        <tr class="hide tr_number_row">
                            <td width="40%" class="bg-gray text-bold">
                                If yes please provide the Tax Registration Number(TRN):
                            </td>
                            ...
                            <td colspan="2" style="display: flex;">
                                ...
                                for ($i = 1; $i <= 9; $i++) {
                                    ...
                                    <input type="text" maxlength="1"
                                           class="form-control input_bar" id="tr_number" name="tr_number[]"
                 ...
                 <div class="text-align-right w-100 d-flex justify-content-between">
                    <button class="move-back btn btn-primary" type="button" data-toggle="collapse" data-target="#contact" aria-expanded="true" aria-controls="contact">Back</button>
                    <button class="move-next btn btn-success" type="button" data-toggle="collapse" data-target="#insurance" aria-expanded="true" aria-controls="insurance">Next</button>
                </div>
                </div>
            </section>
            <section class="insurance_detail section mb-20">
                <h1>Insurance Details</h1>
                <div id="insurance" class="collapse" aria-labelledby="headingOne" data-parent="#accordion">
                    <table class="table table-bordered" style="border-color: #212529">
                        <tbody>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td width="20%"><input class="form-check-input is_public_liability" type="radio"
                        ...
                        <tr class="insurance_indicate_options">
                    ...
                    <div class="text-align-right w-100 d-flex justify-content-between">
                        <button class="move-back btn btn-primary" type="button" data-toggle="collapse" data-target="#banking" aria-expanded="true" aria-controls="banking">Back</button>
                    <button class="move-next btn btn-success" type="button" data-toggle="collapse" data-target="#summerProject" aria-expanded="true" aria-controls="summerProject">Next</button>
                </div>
                </div>
            </section>
            <section class="summer_project_detail section mb-20">
                <h1>Summer Project Details</h1>
                <div id="summerProject" class="collapse" aria-labelledby="headingOne" data-parent="#accordion">
                    <table class="table table-bordered" style="border-color: #212529">
                        <tbody>
                        <tr>
                            <td width="60%" colspan="4" class="bg-gray text-bold">
                            ...
                            <td colspan="2">
                                <!--                                <input type="text" class="form-control" id="summer_project_weeks"-->
                                <!--                                                   name="summer_project_weeks">-->
                                <select class="form-control form-select summer_project_weeks" name="summer_project_weeks"
                                        id="summer_project_weeks">

                                    <?php
                                    foreach (totalWeeks() as $week) { ?>
                        ...
                        <tr>
                            <table class="table table-bordered" style="border-color: #212529">
                                <thead>
                                <tr>
                                    <td class="bg-gray text-bold"> Weeks</td>
                                    <td class="bg-gray text-bold"> Specify the total number of days the project will run
                                        for each week
                                    </td>
                                    <td class="bg-gray text-bold"> Specify the total number of hours the project will
                                        run for each day
                                    </td>
                                    <td class="bg-gray text-bold"> Specify the number of Young People
                                        participating each day
                                    </td>
                                    <td class="bg-gray text-bold"> Specify costs of fees, materials and other associated
                                        costs
                                    </td>
                                </tr>
                                </thead>
                                <tbody class="week_detail_options">
                        ...
                        <tr>
                            <table class="table table-bordered" style="border-color: #212529">
                                <tbody>
                                <tr>
                                    <td width="50%" class="bg-gray text-bold">
                                        if the programme is running for more than 8 weeks,
                                        please include additional information on a separate sheet.
                                        Grant available (subject to budget) is €200 per day for a minimum 7 hours per
                                        day,
                                    ...
                                    <td class="">
                                        Total Cost = <div class="input-group">
  <div class="input-group-prepend">
    ...
    <input type="text" class="form-control" id="total_cost"
                    ...
                    <div class="text-align-right w-100 d-flex justify-content-between">
                        <button class="move-back btn btn-primary" type="button" data-toggle="collapse" data-target="#insurance" aria-expanded="true" aria-controls="insurance">Back</button>
                    <button class="move-next btn btn-success" type="button" data-toggle="collapse" data-target="#assuranceSection" aria-expanded="true" aria-controls="assuranceSection">Next</button>
                </div>
                </div>
            </section>
            <section class="club_assurance_declaration section mb-20">
                <h1>Club /Group Declaration of Assurance</h1>
                <div id="assuranceSection" class="collapse" aria-labelledby="headingOne" data-parent="#accordion">
                    <table class="table table-bordered" style="border-color: #212529">
                        <tbody>
                        <tr>
                     ...
                     <div class="text-align-right w-100 d-flex justify-content-between">
                        <button class="move-back btn btn-primary" type="button" data-toggle="collapse" data-target="#summerProject" aria-expanded="true" aria-controls="summerProject">Back</button>
                    <button class="move-next btn btn-success" type="button" data-toggle="collapse" data-target="#declaration" aria-expanded="true" aria-controls="declaration">Next</button>
                </div>
                </div>
            </section>
            <section class="supporting_agency_declaration section mb-20">
                <h1>Supporting Agency Declaration</h1>
                <div id="declaration" class="collapse" aria-labelledby="headingOne" data-parent="#accordion">
                    <table class="table table-bordered" style="border-color: #212529">
                        <tbody>
                        <tr>
                     ...
                     <div class="text-align-right w-100 d-flex justify-content-between">
                        <button class="move-back btn btn-primary" type="button" data-toggle="collapse" data-target="#assuranceSection" aria-expanded="true" aria-controls="assuranceSection">Back</button>
                    <button class="move-next btn btn-success" type="button" data-toggle="collapse" data-target="#statement" aria-expanded="true" aria-controls="statement">Next</button>
                </div>
                </div>
            </section>
            <section class="data_privacy_statement section mb-20">
                <h1>Data Privacy Statement</h1>
                <div id="statement" class="collapse" aria-labelledby="headingOne" data-parent="#accordion">
                    <table class="table table-bordered" style="border-color: #212529">
                        <tbody>
                        <tr>
                    ...
                    <div class="d-flex justify-content-between" style="margin: 10px 0 20px 0;">
                        <button class="move-back btn btn-primary" type="button" data-toggle="collapse" data-target="#declaration" aria-expanded="true" aria-controls="declaration">Back</button>
                        <div>
                            <a class="btn btn-success" href="draft.php" style="margin-right:10px ">save draft</a>
                ...
                <div class="container">
                    <div class="eftForm">
                                ...
                                <table class="table" style="border-color: #212529">
                                        ...
                                        <td style="display: flex">
                                            ...
                                            for ($i = 1; $i <= 4; $i++) {
                                                ...
                                                <input type="text" maxlength="1" onkeypress="return isNumberKey(event)"
                                                       class="form-control input_bar" id="gmis_no" name="gmis_no[]" readonly>
                                                <?php
                                            }
                                            ?>
                                        </td>
                                    ...
                                    <tr class="right-align">
                                        ...
                                        <td><input type="email" class="form-control" id="premises_address"
                                                   name="remittance_email" value="finance@cdysb.cdetb.ie" readonly="">
                                        </td>
                                    </tr>
                                    </tbody>
                                </table>
                        ...
                        <p class="color-light-blue right-align form_guidance">
                            ...
                            <!--                            <span class="bg-gray text-bold color-light-blue"><u>Clear Block Capitals</u></span>-->
                        </p>
                        ...
                        <section class="bank_details etfSection">
                            ...
                            <div>
                                <table class="table" style="border-color: #212529">
                                    <tbody>
                                    <tr>
                                        <td width="" colspan="" class="color-light-blue right-align">Name Of Bank:
                                        </td>
                                        <td colspan="">
                                    ...
                                    <tr>
                                        <td width="" colspan="" class="color-light-blue right-align">Address Of
                                            Bank:
                                        </td>
                                        <td colspan="">
                                    ...
                                    <tr>
                                        <td width="" colspan="" class="color-light-blue right-align">Bank Account
                                            Name: <br><span>As on bank statement</span>
                                        </td>
                                        <td colspan="">
